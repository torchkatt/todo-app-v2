    ...
    <div className="bg-gradient-to-br from-purple-700 via-indigo-700 to-purple-900 rounded-2xl p-6 text-white shadow-xl shadow-purple-200">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-purple-200">{t('wallet.title')}</span>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="text-xs text-purple-200 mt-1">{t('wallet.balance')}</div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-white/10 rounded-xl py-3 px-3">
          <div className="text-[10px] text-purple-200 font-semibold">{t('wallet.cashbackTotal')}</div>
